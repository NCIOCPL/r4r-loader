...
describe('GithubResourceSource', () => {
    ...
    describe('begin', () => {
        ...
        // Minimal test should begin gain functionality in the future.
        it('succeeds', async () => {

            const instance = await GithubResourceSource.GetInstance(logger, VALID_CONFIG);
    ...
    describe('end', () => {
        ...
        // Minimal test should end gain functionality in the future.
        it('succeeds', async () => {
    ...
    describe('abort', () => {
        ...
        // Minimal test should abort gain functionality in the future.
        it('succeeds', async () => {
